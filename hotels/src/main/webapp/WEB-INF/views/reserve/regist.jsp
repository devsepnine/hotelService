...
<div class="reserve-wrap">
	<div class="left-wrap">
		...
		<div class="left-con">
			...
			<input class="form-control" type="text" value="${mdto.member_name}" id="reserve_name" placeholder="체크인시 필요한 정보입니다." required>
		</div>
		
		<div class="left-con">
			<label for="reserve_phone">휴대폰 번호</label>
			<input class="form-control" type="text" value="${mdto.member_phone}" id="reserve_phone" placeholder="체크인시 필요한 정보입니다." required>
		</div>
		
		<h3>결제수단 선택</h3>
		
		<div class="left-con">
			<select class="reserve_pay form-control" style="width: 150px;">
				<option value="kakaopay">카카오페이</option>
				<option value="non-account">무통장입금</option>
			</select>
		</div>
		
		<div class="left-con agree-box">
			<div class="custom-control custom-checkbox">
		      <input type="checkbox" class="custom-control-input" id="a_check">
		    ...
		    <div class="custom-control custom-checkbox agree-wrap">
		      <input type="checkbox" class="custom-control-input" id="check_1" name="check_agree">
		      <label class="custom-control-label" for="check_1"></label>
		      <span>숙소이용규칙 및 취소/환불 규정 동의 <b>(필수)</b></span>
		    </div>
		    <br>
		    <div class="custom-control custom-checkbox agree-wrap">
		      <input type="checkbox" class="custom-control-input" id="check_2" name="check_agree">
		      <label class="custom-control-label" for="check_2"></label>
		      <span>개인정보 수집 및 이용 동의 <b>(필수)</b></span>
		    </div>
		    <br>
		    <div class="custom-control custom-checkbox agree-wrap">
		      <input type="checkbox" class="custom-control-input" id="check_3" name="check_agree">
		      <label class="custom-control-label" for="check_3"></label>
		      <span>개인정보 제 3자 제공 동의 <b>(필수)</b></span>
		    </div>
		    <br>
		    <div class="custom-control custom-checkbox agree-wrap">
		      <input type="checkbox" class="custom-control-input" id="check_4" name="check_agree">

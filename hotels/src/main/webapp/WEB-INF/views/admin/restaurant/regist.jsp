		...
		<table class="table_ny_one" align="center" >
			<tbody>
				<tr>
					...
					<td class="td-line">
						<input type="text" style="width:300px;" name="restaurant_name" placeholder="레스토랑 이름을 입력하세요" required>
					</td>
				</tr>
				<tr>
					...
					<td><input class="form-control" type="text" style="display: inline-block;width: 40%" name="restaurant_postcode" placeholder="우편번호" required readonly>
						<input class="btn btn-danger" type="button" style="width:100px" value="우편번호 찾기" name="postcode_find"><br> 
						<input class="form-control" type="text" name="restaurant_addr1" placeholder="주소" required readonly>
						<input class="form-control" type="text" name="restaurant_addr2" placeholder="상세주소">
					</td>
				</tr>
				<tr height="500">
					<td valign="top" colspan="2">
						<textarea name="restaurant_info" placeholder="레스토랑 설명을 입력하세요"></textarea>
					</td>
				</tr>
				<tr>
					<td colspan="2">
						<div id="map" style="width:100%;height:300px;"></div>
						<input type="hidden" id="restaurant_lng" name="restaurant_lng" value="">
						<input type="hidden" id="restaurant_lat" name="restaurant_lat" value="">
					</td>
				</tr>
				<tr>
					<td colspan="2">
			...
			<tfoot>
				<tr>
					<td class="td-line" colspan="2"  style="text-align: right;">
						<input type="submit" style="width:70px" class="btn btn-danger" value="레스토랑 등록">
					</td>
				</tr>
			</tfoot>
		</table>

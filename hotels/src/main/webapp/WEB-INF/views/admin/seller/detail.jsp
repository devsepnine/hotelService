...
<script>
	$(function(){
		$("#deleteBtn").click(function(){
			...
			$.ajax({
// 				url : "../check_pw_seller",
				url : "${pageContext.request.contextPath}/admin/check_pw_seller",
				type: "post",
				data : {
					pw : encPw
				},
		...
		<tr>
			<td colspan="2">
				<div style = "margin-top:40px">
					...
					<button type="button" name="exitbtn"  class="btn btn-danger exitbtn" data-toggle="modal" data-target="#deleteCheckModal">판매자 탈퇴</button>
				</div>
			</td>
		</tr>
	</tfoot>
